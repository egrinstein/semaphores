all: 
	...
	gcc -o async2 channel.c testeasync.c -lpthread -lrt -DPRODS=10 -DCONS=10 -DN=10 -DBUFF_SIZE=5 
	gcc -o async3 channel.c testeasync.c -lpthread -lrt -DPRODS=10 -DCONS=10 -DN=10 -DBUFF_SIZE=20 
