all: 
	...
	gcc -o async5 channel.c testeasync.c -lpthread -lrt -DBUFF_SIZE=10  -DPRODS=10 -DCONS=10 -DN=10
	...
	gcc -o sync5 channel.c testesync.c -lpthread -lrt -DPRODS=10 -DCONS=10 -DN=10
